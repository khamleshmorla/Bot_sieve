...
def score_account(account: Dict[str, Any]) -> float:
    ...
    if velocity > 100:
        ...
        score += 35      # Increased from 22
    elif velocity > 20:
        score += 25      # Increased from 14
    elif velocity > 8:
    ...
    # Missing basic profile details is a strong indicator of low-effort bot generation
    if not has_pic:
        score += 25      # Increased from 15
    if not has_bio:
        score += 20      # Increased from 12
